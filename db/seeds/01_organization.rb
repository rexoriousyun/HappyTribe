scott_mission_1 =  Organization.create(
...
postmedia_3 =  Organization.create(
  name: "Postmedia",
...
toronto_humane_4 =  Organization.create(
...
sick_kids_5 =  Organization.create(
  name: "Sick Kids",
...
heart_and_stroke_8 =  Organization.create(
...
toronto_environment_9 = Organization.create(
